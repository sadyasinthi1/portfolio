...
const Services = () => {
  return (
    ...
    <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am a frontend developer from Toronto, Canada with years of experience in multiple companies.</p>
